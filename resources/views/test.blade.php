...
@section('content')
    <FORM action="https://n.gomypay.asia/TestShuntClass.aspx" method="post">
        ...
        <input name='Order_No' value='{{ $orderCode }}'>
        ...
        <input name="Callback_Url" value="{{ route('shop.pay.gomypay.callback') }}">
        <input name="Return_url" value="{{ route('shop.pay.gomypay.return') }}">
