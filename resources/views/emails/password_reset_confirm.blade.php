...
<html>
<head>
    <!-- Compiled with Bootstrap Email version: 1.3.0 --><meta http-equiv="x-ua-compatible" content="ie=edge">
                                                ...
                                                <table class="card-body" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                            <h1 class="h3" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="left">Antiquary 帳戶</h1>
                                                            ...
                                                            <h5 class="text-teal-700" style="color: #003a6c; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;" align="left">忘記密碼</h5>
                                                            ...
                                                            <div class="space-y-3">
                                                                <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left">{{$user->name}} 您好，請在30分鐘內點選下面按鈕來重置您的密碼。</p>
                                                                ...
                                                                <table class="btn btn-primary" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;" align="center" bgcolor="#0d6efd">
                                                                            <a href="{{ $passwordResetLink }}" target="_blank" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #003a6c; padding: 8px 12px; border: 1px solid #003a6c;">確認重置</a>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                            ...
                                                            <p class="text-gray-700" style="line-height: 24px; font-size: 12px; color: #4a5568; width: 100%; margin: 0;" align="left">若您沒進行此操作，請忽略此信件，並向管理員聯絡。此電子郵件由系統自動發出，請勿直接回覆，謝謝您。</p>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
