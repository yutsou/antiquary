                                                ...
                                                <table class="card-body" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                            ...
                                                            <h5 class="text-teal-700" style="color: #003a6c; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;" align="left">Email驗證碼</h5>
                                                            ...
                                                            <div class="space-y-3">
                                                                <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left">{{$user->name}} 您好，您正在進行Email的驗證，請在驗證頁面輸入以驗證碼。</p>
                                                            ...
                                                            <p class="text-gray-700" style="line-height: 24px; font-size: 12px; color: #4a5568; width: 100%; margin: 0;" align="left">
                                                                若您沒進行此操作，請忽略此信件。此電子郵件由系統自動發出，請勿直接回覆，謝謝您。
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    </tbody>
